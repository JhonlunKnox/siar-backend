...
const { listar, obtener, obtenerPorMes, crear, actualizar, enviar, generarXML } = require('../controllers/sui.controller');
const authMiddleware = require('../middleware/auth.middleware');
const { requireRoles } = require('../middleware/roles.middleware');
const { validate } = require('../middleware/validate.middleware');
const { crearReporteSchema, actualizarReporteSchema } = require('../validators/sui.validator');
